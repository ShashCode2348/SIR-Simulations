...
class ParticleList(list):
    def __init__(self, particles=[]):
        ...
        self.R_vals, self.I_and_R_vals, self.I_R_S_vals = [0], [0], [population]
        self.x_vals = [0.0]
    ...
    def update_graph(self):
        ...
        self.I_R_S_vals.append(sum(1 for p in self if p.state != -1))
        ...
        axes.fill_between(particle_list.x_vals, particle_list.I_R_S_vals, population, color="#51ED51", alpha=1, label='Vaccinated')
...
class Particle:
    def __init__(self, position, velocity_dir, acceleration_dir, state):
        ...
        self.state = state  #  -1: Vaccinated, 0: Susceptible, 1: Infected, 2: Removed
...
circle_radius = 3
colour_dict = {-1: "#51ED51", 0: "#4C88F7", 1: "#ED5151", 2: "#676767"}
...
axes.fill_between(particle_list.x_vals, 0, particle_list.R_vals, color="#676767", alpha=1, label='Removed')
axes.fill_between(particle_list.x_vals, particle_list.R_vals, particle_list.I_and_R_vals, color="#ED5151", alpha=1, label='Infected')
axes.fill_between(particle_list.x_vals, particle_list.I_and_R_vals, particle_list.I_R_S_vals, color="#4C88F7", alpha=1, label='Susceptible')
axes.fill_between(particle_list.x_vals, particle_list.I_R_S_vals, population, color="#51ED51", alpha=1, label='Vaccinated')
